...
start_arglist (void)
{
  struct funcall *new_funcall;

  new_funcall = (struct funcall *) xmalloc (sizeof (struct funcall));
  new_funcall->next = funcall_chain;
  new_funcall->arglist_len = arglist_len;
  arglist_len = 0;
  funcall_chain = new_funcall;
}
