...
macro_include (struct macro_source_file *source,
               ...
               const char *included)
{
  struct macro_source_file *new_src;
  ...
  /* At this point, we know that LINE is an unused line number, and
     *LINK points to the entry an #inclusion at that line should
     precede.  */
  new_src = new_source_file (source->table, included);
  new_src->included_by = source;
  new_src->included_at_line = line;
  new_src->next_included = *link;
  *link = new_src;
