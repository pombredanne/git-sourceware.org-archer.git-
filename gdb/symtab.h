...
#define SET_SYMBOL_VALUE_ADDRESS(symbol, addr) \
  (((symbol)->ginfo.value.address) = (addr))
...
#define MSYMBOL_SET_LANGUAGE(symbol,language) \
  (symbol_set_language (&(symbol)->mginfo, (language)))
